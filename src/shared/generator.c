...
int generator_write_veritysetup_unit_section(
        ...
        fprintf(f,
                "[Unit]\n"
                "Description=Verity Setup for %%I\n"
...
int generator_write_veritysetup_service_section(
        ...
        _cleanup_free_ char *name_escaped = NULL, *data_what_escaped = NULL, *hash_what_escaped, *roothash_escaped = NULL, *options_escaped = NULL;
        ...
        fprintf(f,
                ...
                data_what_escaped, name_escaped, hash_what_escaped, roothash_escaped, strempty(options_escaped),
                name_escaped);
